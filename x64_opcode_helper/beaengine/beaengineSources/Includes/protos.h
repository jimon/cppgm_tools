...
void __bea_callspec__ GvMptp(PDISASM);
...
void __bea_callspec__ cmovge_(PDISASM);
void __bea_callspec__ cmovle_(PDISASM);
void __bea_callspec__ cmovg_(PDISASM);
...
void __bea_callspec__ jge_(PDISASM);
void __bea_callspec__ jle_(PDISASM);
void __bea_callspec__ jg_(PDISASM);
void __bea_callspec__ jo_near(PDISASM);
void __bea_callspec__ jno_near(PDISASM);
void __bea_callspec__ jb_near(PDISASM);
void __bea_callspec__ jae_near(PDISASM);
...
void __bea_callspec__ jge_near(PDISASM);
void __bea_callspec__ jle_near(PDISASM);
void __bea_callspec__ jg_near(PDISASM);
