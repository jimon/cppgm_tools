...
void (__bea_callspec__ * opcode_map1[])(PDISASM) = {
    ...
    jo_       , jno_      , jb_       , jae_      , je_       , jne_      , jbe_      , ja_       , js_       , jns_      , jp_       , jnp_      , jl_       , jge_      , jle_      , jg_       ,
...
void (__bea_callspec__ *opcode_map2[])(PDISASM) = {
    ...
    cmovo_    , cmovno_   , cmovb_    , cmovae_   , cmove_    , cmovne_   , cmovbe_   , cmova_    , cmovs_    , cmovns_   , cmovp_    , cmovnp_   , cmovl_    , cmovge_   , cmovle_   , cmovg_    ,
